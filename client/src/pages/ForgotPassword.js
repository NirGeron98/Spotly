        ...
        <div className="container mx-auto px-6">
          <div className="max-w-md mx-auto w-full">
            <div className="bg-white/70 backdrop-blur-lg border border-blue-100 rounded-3xl shadow-2xl px-6 py-8 transition-all duration-500">
              ...
              {message && (
                <div className="mb-4 bg-green-100 border border-green-300 text-green-700 px-3 py-2 rounded-xl">
              ...
              <div className="mt-4 text-center">
                <p className="text-blue-700 mb-2 text-sm">נזכרת בסיסמה שלך?</p>
                <button
                  type="button"
                  onClick={() => window.history.back()}
                  className="inline-flex items-center px-4 py-2 border border-blue-300 text-blue-700 font-semibold rounded-xl hover:bg-blue-100 transition-all duration-300 text-sm"
                >
                  חזור להתחברות
                </button>
              </div>
              ...
              <div className="mt-5 p-3 bg-blue-50 rounded-xl border border-blue-200">
                <div className="flex items-start">
                  <span className="text-blue-600 text-base ml-2 mt-0.5">💡</span>
