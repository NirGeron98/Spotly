                ...
                <>
                    ...
                    {["apartment", "house", "rental"].map((type) => (
                      <button
                        ...
                        className={`py-2 px-4 rounded-md ${
                          formData.residenceType === type ? "bg-blue-500 text-white" : "bg-gray-200"
                        }`}
                      >
                  ...
                  {(formData.residenceType === "apartment" || formData.residenceType === "house") && (
                    <>
                      ...
                      <div className="mb-4">
                        <label className="block text-gray-700 text-sm font-bold mb-2">מספר בית</label>
                        <input
                          type="text"
                          name="buildingNumber"
                  ...
                  <div className="mt-6">
                    <button onClick={handleRegister} className={registerButtonStyle}>
                      הרשמה
                    </button>
                  </div>
                </>
